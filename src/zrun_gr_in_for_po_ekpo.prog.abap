...
***                    create Invoice*************
    ...
    ELSE. "GR completed **    check if INV completed
      ...
      SELECT * FROM zdatagen_logging INTO TABLE lt_log_gr WHERE external_document = ls_logging-ebeln
...
*        modify zdatagen_logging from ls_log.
*        delete lt_log_gr index 1.
        DELETE zdatagen_logging FROM TABLE lt_log_gr.
      ENDIF.
...
*      DATA : ls_log TYPE zdatagen_logging.
      CLEAR : ls_log.
      SELECT * FROM zdatagen_logging INTO TABLE lt_log_in WHERE external_document = ls_logging-ebeln
...
*        delete lt_log_in index 1.
        DELETE zdatagen_logging FROM TABLE lt_log_in.
      ENDIF.
    ENDIF.
