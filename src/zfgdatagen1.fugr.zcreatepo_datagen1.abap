...
*FUNCTION zcreatepo_datagen.
  ...
  DATA: lv_postingdate TYPE eeind."dats.
...
************added by i065658********
      ...
      ELSEIF wa_poitem-plant EQ '1010'.
        ...
        i_itemx-tax_code = 'X'.
      ELSEIF wa_poitem-plant EQ '3010'.
        i_item-tax_code = 'P0'.
        i_itemx-tax_code = 'X'.
      ENDIF.
*******************************
...
*}   REPLACE
      ...
      IF wa_poitem-delivery_date IS NOT INITIAL.
        ...
        lv_postingdate = wa_poitem-delivery_date.
      ENDIF.
...
*      CONCATENATE wa_log-msg 'and also released' into wa_log-msg SEPARATED BY space.
    ...
    LOOP AT it_poitems INTO wa_poitem WHERE pohdr_seqno = wa_pohdr-pohdr_seqno.
      IF lv_itm EQ 0.
        lv_itm = lv_itm + 1.
      ENDIF.
      wa_log-date_posted = lv_postingdate.
...
*      ls_datagen_log-delivery_date = wa_poitem-delivery_date.
      ...
      ls_datagen_log-date_posted = lv_postingdate.
...
****    added by I065658
    SORT lt_datagen_log DESCENDING BY documentno ASCENDING. "iseq_no documentno.
    DELETE ADJACENT DUPLICATES FROM lt_datagen_log COMPARING documentno. "we need to this to have only one entry into the logging table
